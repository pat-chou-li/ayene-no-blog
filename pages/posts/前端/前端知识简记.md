...
- 引入了**头信息压缩**，一方面，头信息使用 Head compress（Hpack算法，包含静态表、动态表和huffman编码） 压缩后再发送，具体来说，一个字段会被压缩成以下信息
  ...
  ![image-20250311152830944](C:\Users\ayanewu\AppData\Roaming\Typora\typora-user-images\image-20250311152830944.png)
...
1、 深度参与一个前端开源，或者做一个轮子项目，从 工程化 / 图形学 / 音视频 里选一个，秋招可以对着一些独特的支持类部门投

2、还是继续背八股刷题找一个暑期，秋招主要靠bg和实习说话
